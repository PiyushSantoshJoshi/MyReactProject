...
export default function HeaderSTab() {
  return (
    <>
    <div className="container-fluid bg-primary text-white text-center stab">
        <div className="row">
          ...
          <div className=" col-6 border dropdown">
            <button
              type="button"
          ...
          <div className=" col-6 border bg-white">
            <nav className="p-0 navbar navbar-expand  justify-content-center">
